    ...
    return (
        <div className="flex justify-center h-[900px] bg-gray-400 z-[1]" id="Team">
          ...
          <div className="grid">
            ...
            <div className="h-[3px] bg-white w-80 lg:w-[500px] m-auto"></div>
          </div>
          <div className="m-auto  grid grid-cols-2 lg:grid-cols-3 gap-10 px-10">
            <div>
              <a href="https://twitter.com/HeyDody">
                <div className="px-10  drop-shadow-[0px_10px_20px_rgba(0,0,0,1)] hover:drop-shadow-[0px_5px_20px_rgba(0,0,0,1)] transition-all ease-out hover:translate-x-1 hover:translate-y-1 cursor-pointer">
