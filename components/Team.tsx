  ...
  return (
    <div className="flex justify-center h-[1200px] lg:h-[900px] bg-gray-400 z-[1]" id="Team">
      ...
      <div className="z-[4] flex flex-col lg:mx-10 text-white">
        ...
        <div className="mt-16 lg:m-auto grid grid-cols-2 lg:grid-cols-3 2xl:grid-cols-6 gap-5 gap-y-16 md:gap-10 md:gap-y-20 overflow-hidden">
          <Swiper
            slidesPerView={1}
            effect={"flip"}
            loop={true}
          ...
          >
            <SwiperSlide>
              <SwiperButtonNext>
                <div>
                  <div className="h-[280px] lg:h-[340px] px-10 drop-shadow-2xl hover:drop-shadow-lg lg:drop-shadow-[0px_10px_20px_rgba(0,0,0,.6)] lg:hover:drop-shadow-[0px_5px_20px_rgba(0,0,0,.4)] transition-all ease-out hover:translate-x-1 hover:translate-y-1 cursor-pointer bg-slate-800 rounded-xl py-8">
            ...
            <SwiperSlide>
              <SwiperButtonNext>
                <div>
                    <div className="h-[280px] lg:h-[340px] flex px-5 drop-shadow-2xl hover:drop-shadow-lg lg:drop-shadow-[0px_10px_20px_rgba(0,0,0,.6)] lg:hover:drop-shadow-[0px_5px_20px_rgba(0,0,0,.4)] transition-all ease-out hover:translate-x-1 hover:translate-y-1 cursor-pointer bg-slate-800 rounded-xl py-8">
