      ...
      <div className="flex justify-center h-[1100px] lg:h-[950px] bg-gray-500 z-[1]" id="Faq">
        ...
        <div className="z-[3] mt-[300px] text-white">
          <div className="grid grid-cols-1 gap-1 mx-8 lg:w-[500px] m-auto">
            <div onClick={setBoxOne} className={box1 === true ? "bg-slate-800 h-[550px] lg:h-[380px] max-w-[300px] lg:max-w-[500px] rounded-lg transition-all cursor-pointer" : "bg-slate-800 rounded-lg h-[60px] max-w-[300px] lg:max-w-[500px] transition-all cursor-pointer"}>
              <div className="text-sm lg:text-lg font-bold px-8 py-[18px] drop-shadow-[15px_10px_10px_rgba(0,0,0,0.4)] select-none">What is the abyss?</div>
            ...
            <div onClick={setBoxTwo} className={box2 === true ? "bg-slate-800 h-[405px] lg:h-[290px] max-w-[300px] lg:max-w-[500px] rounded-lg transition-all cursor-pointer" : "bg-slate-800 rounded-lg h-[60px] max-w-[300px] lg:max-w-[500px] transition-all cursor-pointer"}>
              <div className="text-sm lg:text-lg font-bold px-8 py-[18px] drop-shadow-[15px_10px_10px_rgba(0,0,0,0.4)] select-none">What do holders get?</div>
            ...
            <div onClick={setBoxThree} className={box3 === true ? "bg-slate-800 h-[500px] lg:h-[325px] max-w-[300px] lg:max-w-[500px] rounded-lg transition-all cursor-pointer" : "bg-slate-800 rounded-lg h-[60px] max-w-[300px] lg:max-w-[500px] transition-all cursor-pointer"}>
              <div className="text-sm lg:text-lg font-bold px-8 py-[18px] drop-shadow-[15px_10px_10px_rgba(0,0,0,0.4)] select-none">Where can I go to join?</div>
            ...
            <div onClick={setBoxFour} className={box4 === true ? "bg-slate-800 h-[580px] lg:h-[380px] max-w-[300px] lg:max-w-[500px] rounded-lg transition-all cursor-pointer" : "bg-slate-800 rounded-lg h-[60px] max-w-[300px] lg:max-w-[500px] transition-all cursor-pointer"}>
              <div className="text-sm lg:text-lg font-bold px-8 py-[18px] drop-shadow-[15px_10px_10px_rgba(0,0,0,0.4)] select-none">How much does it cost?</div>
