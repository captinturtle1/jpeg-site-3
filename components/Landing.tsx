...
const Landing = () => {
  return (
    <div className="flex relative justify-center h-[1000px] lg:h-[970px] bg-gray-900" id="Landing">
      ...
      <div className="z-[4] grid grid-cols-1 h-[800px] lg:h-[900px] lg:grid-cols-2 gap-0 lg:gap-20">
        <div className="mx-auto mt-20 xs:mt-32 lg:m-auto w-[200px] xs:w-[300px] lg:w-[650px] flex justify-center drop-shadow-[15px_10px_10px_rgba(0,0,0,0.4)]">
          <div>
            <Image src={squid}/>
          </div>
        </div>
