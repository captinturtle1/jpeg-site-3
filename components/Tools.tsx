    ...
    return (
        <div className="flex justify-center h-screen bg-gray-200 z-[1]" id="Tools">
          ...
          <div className="m-auto z-[4] grid grid-cols-1 lg:grid-cols-2 gap-10">
            <div className="grid bg-slate-900 p-10 rounded-3xl drop-shadow-[15px_10px_10px_rgba(0,0,0,0.4)]">
              <img className="m-auto  hidden lg:block h-96 xl:h-[18vw] drop-shadow-[15px_10px_10px_rgba(0,0,0,0.4)]" src={example[0].src}></img>
              <div className="pt-5 font-bold">{example[1]}</div>
              <div className="pt-5 max-w-lg">{example[2]}</div>
            </div>
